...
./b2 cxxflags=" -fPIC -arch x86_64" cflags=" -fPIC $CFLAGS " -j$cpuX2 --with-system --with-filesystem --with-program_options --with-thread --with-chrono --with-timer --with-regex install --prefix=./build/ && \
